...
echo "\n"
curl -u cube:cube1234 -X POST -H "Content-Type: application/vnd.collection+json" -d '{"template":{"data":[{"name":"title", "value":"TestQuery1"},{"name":"query", "value":"{\"SeriesInstanceUID\": \"1.3.12\"}" }]}}' 'http://localhost:8000/api/v1/pacs/1/queries/'
echo "\n"
